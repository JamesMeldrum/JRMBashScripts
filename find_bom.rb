...
# Find files with an Unicode BOM (Byte Order Mark) for UTF-8
# encoding (which doesn't actually say anything about byte order
# as that is a non-issue with UTF-8).
#
